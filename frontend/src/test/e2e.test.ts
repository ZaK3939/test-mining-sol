...
describe('E2E Tests - Real User Scenarios', () => {
  ...
  describe('Scenario 1: New User Complete Journey', () => {
    it(
      'should simulate complete new user experience',
      async () => {
        const alice = users[0];
  ...
  describe('Scenario 2: Referral System', () => {
    it(
      'should simulate referral relationships',
      async () => {
        const bob = users[1];
  ...
  describe('Scenario 3: Multi-User Concurrent Operations', () => {
    it(
      'should handle multiple users operating simultaneously',
      async () => {
        ...
        logger.info(
          `✅ Concurrent operations: ${analysis.successCount}/${results.length} succeeded`
        );
      },
      TEST_CONSTANTS.TIMEOUTS.DEFAULT
    );
  ...
  describe('Scenario 4: Progressive Feature Usage', () => {
    it(
      'should simulate progressive feature adoption',
      async () => {
        const alice = users[0];
  ...
  describe('Scenario 5: Performance Under Load', () => {
    it(
      'should maintain responsiveness under user load',
      async () => {
